...
create index if not exists idx_messages_sender_recipient_created_at on public.messages(sender_id, recipient_id, created_at desc);
create index if not exists idx_friend_requests_to_status_created_at on public.friend_requests(to_user, status, created_at desc);
create index if not exists idx_group_messages_group_created_at on public.group_messages(group_id, created_at desc);
create index if not exists idx_group_message_reactions_message on public.group_message_reactions(message_id);
create index if not exists idx_event_messages_event_created_at on public.event_messages(event_id, created_at desc);
create index if not exists idx_event_message_reactions_message on public.event_message_reactions(message_id);
create index if not exists idx_event_invites_event_created_at on public.event_invites(event_id, created_at desc);
