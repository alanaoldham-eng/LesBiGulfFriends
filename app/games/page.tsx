...
export default function GamesPage() {
  ...
  useEffect(() => { listGamesHub().then(setGames).catch(() => setGames([])); }, []);
  return (
    <ClientShell>
      <section className="hero">
        <h1 style={{ margin: 0, fontSize: 30 }}>Games</h1>
        <p style={{ fontSize: 16, lineHeight: 1.6, opacity: 0.9 }}>
          Build habits, earn karma, and have fun with community-powered games, blind chat, anonymous spaces, and the new consensual roleplay game.
        </p>
      </section>
      <div className="grid">
        <section style={{ border: "1px solid #e9d7e2", borderRadius: 24, padding: 20, background: "linear-gradient(180deg, #fff, #fff7fb)" }}>
          ...
          <p style={{ opacity: 0.85, lineHeight: 1.7 }}>Every morning, meditate and post your intention for the day. Earn 0.1 karma for each daily check-in, protect your streak, and climb the leaderboard.</p>
        ...
        <section style={{ border: "1px solid #e9d7e2", borderRadius: 24, padding: 20, background: "#fff" }}>
          ...
          <p style={{ opacity: 0.85, lineHeight: 1.7 }}>Match with someone new without seeing who they are. If both of you want to reveal later, you can.</p>
          <Link className="button secondary" href="/games/blind-chat">Open blind chat</Link>
        </section>
        <section style={{ border: "1px solid #e9d7e2", borderRadius: 24, padding: 20, background: "#fff" }}>
          <div style={{ fontSize: 34, marginBottom: 8 }}>⛓️</div>
          <h3 style={{ marginTop: 0 }}>Roleplay Game</h3>
